          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-4 footer__widget footer__widget-about  mb-30">
              <div class="footer__widget-content">
                ...
                <p style="color: #156B9C;"><a href="tel:+91 8882361616" class="font-weight-bold">+91 8882361616</a></p>
              </div>
            </div><!-- /.col-lg-4 -->
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-4 footer__widget footer__widget-newsletter">
              <div class="footer__widget-content">
                ...
                <p>Sign up for Packaging and Printing alerts, our latest news, thoughts, and insights from JMB Packaging.</p>
              ...
              <div class="footer__copyright">
                <nav>
                  <ul class="list-unstyled footer__copyright-links d-flex flex-wrap">
                    <li>
                      <a href="https://thehybridutopia.com">
                        &copy; 2024 JMB Packaging, with Love by <span class="color-theme">Hybrid Utopia</span>
                      </a>
                    </li>
